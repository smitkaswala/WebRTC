...
public class Connection implements PeerConnection.Observer{
    ...
    private static final String MEDIA_STREAM_ID = "";
    private static final String VIDEO_TRACK_ID = "";
    private static final String AUDIO_TRACK_ID = "";
    private static final int VIDEO_HEIGHT = 480;
    private static final int VIDEO_WIDTH = 640;
    private static final int VIDEO_FPS = 30;

    private static final String STUN_SERVER_URL = "";
    ...
    public void initializeMediaDevices(final Context context, final SurfaceViewRenderer localRenderer) throws Exception {
        ...
        // Video capture and localRenderer needs to be initialized
